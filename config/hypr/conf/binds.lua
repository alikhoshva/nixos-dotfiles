...
hl.bind(mainMod .. " + O", hl.dsp.exec_cmd([[hyprctl eval 'hl.monitor({ output = "eDP-1", disabled = true }) hl.monitor({ output = "HDMI-A-1", mode = "3840x2160@120", position = "0x0", scale = 1, disabled = false })']]))
