...
hyprctl eval 'hl.env("QT_SCALE_FACTOR", "1.5") hl.env("GDK_SCALE", "1") hl.env("ELM_SCALE", "1.5")'
...
# 5. Restart Noctalia (quickshell) with 1.5x Qt scaling factor so bar and UI scale up on 4K
